...
function choreograph(grand=false){const colors=Object.keys(palettes);
  ...
  else if(currentFestival==='ryukyu'){const n=mobile?5:grand?10:7;for(let i=0;i<n;i++)setTimeout(()=>launch(-230+i*(460/(n-1)),rand(105,195),i%3===0?'starmine':i%2?'phoenix':'peony',i%2?'rainbow':'azure',rand(-175,-55)),i*145)}
